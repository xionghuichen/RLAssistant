...
RLA_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
...
class ManagerTest(BaseTest):
    ...
    def _load_rla_config(self):
        return load_yaml(os.path.join(RLA_ROOT, 'example/rla_config.yaml'))
